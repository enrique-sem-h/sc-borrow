          ...
          <div className="flex-1 overflow-y-auto px-12 pb-10 space-y-6 custom-scrollbar">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-8">
                ...
                <Input placeholder="Ex: Furadeira de Impacto Bosch" />
              </div>
              ...
              <div className="col-span-4">
                ...
                <div className="relative">
                  <select className="w-full bg-white border border-gray-200 rounded-xl p-3 appearance-none outline-none focus:ring-4 focus:ring-blue-50/50 shadow-sm transition-all text-gray-600">
                    <option value="">Selecione...</option>
                    <option value="">Ferramentas</option>
                    <option value="">Camping</option>
                    <option value="">Equipamentos de festa</option>
            ...
            <div>
              ...
              <textarea className="w-full bg-white border border-gray-200 rounded-2xl p-4 h-28 resize-none outline-none focus:ring-4 focus:ring-blue-50/50 shadow-sm transition-all" />
            </div>
            ...
            <div className="pt-2">
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <Input placeholder="Novo, usado..." />
                </div>

                <div>
                  <Label text="Tamanho" optional />
                  <Input placeholder="Dimensões ou peso" />
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-gray-100">
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl border-2 border-blue-400 text-blue-600 font-serif text-xl font-bold hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all bg-white shadow-lg shadow-blue-50"
              >
                Salvar anúncio
              </button>
            </div>
