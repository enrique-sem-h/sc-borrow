...
export default function EnviarLocatarioPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 relative">
      <ChecklistForm
        titleDescription="Por favor, confirme o estado do item antes de entregar ao locatário"
        buttonText="Enviar solicitação de entrega"
