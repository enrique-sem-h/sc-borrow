...
const TITULO_MOCK = "Furadeira tramontina";
...
export default function EditarAnuncioPage() {
  ...
  const [titulo, setTitulo] = useState(TITULO_MOCK);
          ...
          <div className="flex-1 overflow-y-auto px-12 pb-10 space-y-6 custom-scrollbar">
              ...
              <div className="col-span-4">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-white border border-gray-200 rounded-xl p-3 appearance-none outline-none focus:ring-4 focus:ring-blue-50/50 shadow-sm transition-all text-gray-600"
                  >
                    <option value="">Selecione...</option>
                    <option value="ferramentas">Ferramentas</option>
                    <option value="camping">Camping</option>
                    <option value="festa">Equipamentos de festa</option>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white border border-gray-200 rounded-2xl p-4 h-28 resize-none outline-none focus:ring-4 focus:ring-blue-50/50 shadow-sm transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <div className="relative">
                  <Input
                    value={precoDiario}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setPrecoDiario(maskCurrency(e.target.value))
                    }
                    placeholder="0,00"
                  />
              ...
              <div>
                ...
                <Input
                  value={caucao}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setCaucao(maskCurrency(e.target.value))
                  }
                  placeholder="0,00"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`text-sm font-medium ${
                    disponivel ? "text-green-500" : "text-gray-400"
                  }`}
                >
            ...
            <div className="pt-4 border-t border-gray-100 space-y-3">
              ...
              <button className="w-full py-4 rounded-2xl border-2 border-blue-400 text-blue-600 font-serif text-xl font-bold hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all bg-white shadow-lg shadow-blue-50">
                Salvar alterações
              </button>

              <button className="w-full py-4 rounded-2xl border border-gray-300 text-gray-700 font-serif text-base font-medium hover:bg-gray-50 transition-all bg-white">
                Desativar anúncio temporariamente
              </button>
            </div>
          </div>
        </section>
